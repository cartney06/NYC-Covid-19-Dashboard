...
app.layout = html.Div(children=[
    html.Div(children=[
    html.H1("Time Series of COVID-19 in New York City", style={"text-align":"center", 'color':colors['text']}),
...
def update_graph(metric_selected, seven_day_metric_selected):
    ...
    fig.update_layout(height=480, paper_bgcolor="#21252C", plot_bgcolor="#21252C")
